...
def print_tables(tables):
    for filename in tables.keys():
        ...
        # for i in range(61, 79):  # lines of the f2 in this file
        # for i in range(53, 88):  # lines of f1,f2 and f3 in this file
        for i in range(33, 88):  # lines of mystery,f1,f2 and f3 in this file
        ...
        for filename, lines in coverage.iteritems():
            for line in lines.keys():
                if filename not in tables:
                    tables[filename] = {}
                if line not in tables[filename]:
